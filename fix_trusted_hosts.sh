...
SETTINGS_FILE="$HOME/farmos/www/web/sites/default/settings.php"
DEFAULT_TEMPLATE="$HOME/farmos/www/web/sites/default/default.settings.php"
...
if [ ! -f "$SETTINGS_FILE" ]; then
  if [ -f "$DEFAULT_TEMPLATE" ]; then
    ...
    echo "Run 'ls ~/farmos/www/web/sites/default' to see what's actually there,"
